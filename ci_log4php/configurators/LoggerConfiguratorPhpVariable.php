...
/**
 * LoggerConfiguratorPhpVariable class
 *
 ...
 * @since 2.0
 */
class LoggerConfiguratorPhpVariable implements LoggerConfigurator {
	
	public function configure(LoggerHierarchy $hierarchy, $config = array()) {
		return $this->doConfigure($config, $hierarchy);
	}
	
	private function doConfigure($config, LoggerHierarchy $hierarchy) {
